...
export default function Dashboard() {
  ...
  return (
    <div>
      ...
      <div
        className={`${!mobile && 'mt-section'} d-flex container dashbord-image flex-column-tablet`}>
      ...
      <div className="container dashboard d-flex mt-section fs-30 feature-section flex-column-tablet feature-section-common">
        ...
        <TextAnimation3 Tag="p" className="overview-content mt-3">
          Developing and maintaining a dashboard of this nature, complete with a live data feed, can
          be extremely costly and requires a significant effort. Furthermore, it also reveals your
          true performance, which can be a risk if it's not particularly strong. In contrast, other
          advisory services may prioritize marketing and subscriptions above providing transparency.
          Offering such a detailed analytical platform could potentially hinder their underlying
          motive.
        </TextAnimation3>
      </div>
